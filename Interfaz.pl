...
resource('Atlántico', image, image('atlantico.jpg')).
resource('Bolívar', image, image('bolivar.jpg')).
resource('Boyacá', image, image('boyaca.jpg')).
resource('Caldas', image, image('caldas.jpg')).
resource('Caquetá', image, image('caqueta.jpg')).
resource('Casanare', image, image('casanare.jpg')).
resource('Cauca', image, image('cauca.jpg')).
resource('Cesar', image, image('cesar.jpg')).
resource('Chocó', image, image('choco.jpg')).
resource('Córdoba', image, image('cordoba.jpg')).
resource('Cundinamarca', image, image('cundinamarca.jpg')).
resource('Guainía', image, image('guainia.jpg')).
...
resource('Vaupés', image, image('vaupes.jpg')).
...
send_list(MenuHobbies,append,['Avistamiento Ballenas','Bicicleta','Buggie','Buceo','Cabalgata','Caminata','Caminata Montaña','Camping','Canopy','Careteo','Coleo','Diversión Acuática','Escalar','Espeleología','Hamaca','Jet Ski','Jumping','Kayak','Observación Aves','Observación Aves, Fauna','Observación Aves, Flora y Fauna','Observación Fauna','Observación Flora','Observación Flora y Fauna','Observación Patrimonio Cultural','Observatorio Estrellas','Paracaidismo','Parapente','Playa','Rafting','Rappel','Relajación y Yoga','Sky','Snorkeling','Surf','Teleférico']),
